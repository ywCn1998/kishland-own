...
const packages = [
  {
    ...
    title: "پکیج اکونومی",
    description: "پکیج اکونومی کیش",
    realPrice: "400,000",
    discountedPrice: "350,000",
  },
  {
    image: "/images/package/freePackage.png",
    title: "پکیج اقتصادی",
    description: "پکیج اقتصادی کیش",
    realPrice: "650,000",
        ...
        {packages?.map((p, index) => (
          ...
          >
            ...
            <Grid display={"flex"} gap={1.5} alignItems={"center"}>
              ...
              >
                {(
                  counts[index] * Number(p.realPrice.replace(/,/g, ""))
                ).toLocaleString()}{" "}
              </Typography>
              <Grid display={"flex"} alignItems={"center"}>
                ...
                >
                  {(
                    counts[index] * Number(p.discountedPrice.replace(/,/g, ""))
                  ).toLocaleString()}{" "}
                  تومان
                </Typography>
              </Grid>
