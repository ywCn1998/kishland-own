...
export default function ListSection() {
    ...
    return (
        <>
            <MainTabs data={tabsData} changeCardUi={true} setChangeCardUi={setChangeCardUi} />
            <Grid container spacing={3} sx={{ backgroundColor: "secondary.50", p: 2 }} className="rounded-2xl!">
                {[...Array(3)].map((_, index) => (
            ...
            <img src={'/images/tafrih-banner.png'} className="mt-6! h-[280px]! w-full!" />
            <Grid container mt={3} spacing={3}>
                {[...Array(changeCardUi ? 3 : 6)].map((_, index) => (
                    <Grid key={index} size={changeCardUi ? 12 : 4}>
                        <NormalListCard isWide={changeCardUi} />
            ...
            <img src={'/images/new/tour-ba-ahle-del.png'} className="mt-6! h-[280px]! w-full!" />
            <Grid container mt={3} spacing={3}>
                {[...Array(changeCardUi ? 3 : 6)].map((_, index) => (
                    <Grid key={index} size={changeCardUi ? 12 : 4}>
                        <NormalListCard isWide={changeCardUi} />
