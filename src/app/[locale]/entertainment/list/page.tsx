...
import { Delete, DeleteOutline, KeyboardBackspaceOutlined, ListAlt, ListAltOutlined, Menu, WindowOutlined } from "@mui/icons-material";
import { TourCard } from "./_components/tourCard";
import { BlitType } from "./_components/blitType";
import { AirCard } from "./_components/blitType/aircard";
import { CategorySlider, ExtraFooterInformation } from "@/components/shared/_components";
...
export default function Home() {
  ...
  >
    <Container maxWidth="xl" sx={{ marginBottom: 5 }}>
      ...
      <Stack className="mb-10" display={'flex'} flexDirection={'row'} alignItems={'center'} justifyContent={'space-between'}>
        <Stack display={'flex'} flexDirection={'row'} className="items-center gap-2 ">
      ...
      >
        ...
        <Grid className='pl-[120px]' size={{ md: 8 }} display={'flex'} flexDirection={'column'} justifyContent={'center'}>
          <Typography variant="title">یه دنیا تفریح پرهیجان</Typography>
          <Typography variant="title">تفریحی رویایی در جزیره کیش</Typography>
          <Typography className="mt-8!" variant="sub_title">از تله کابین تا کشتی های تفریحی و پارک دلفین، اینجا برای هر سلیقه‌ای یه انتخاب خاص وجود داره!</Typography>
        </Grid>
