...
export default function NormalListCard({ isWide, isOfferCard = false }: { isWide?: boolean, isOfferCard?: boolean }) {
    return (
        <>
            {!isWide ? (
                <Card
                    ...
                    >
                        <Stack className="flex! flex-row! justify-between!">
                            <Stack className="flex! items-center! gap-3! flex-row!">
                                ...
                                />
                                {!isOfferCard &&
                                    <Typography className="text-sm!" color="primary.main">هتل پنج ستاره</Typography>
                                }
                            </Stack>
                            <TextIcon endIcon={<StarsIcon color="success" className="text-xl!" />} className="text-sm!" sx={{ color: "text.secondary" }} text={<Typography>{isOfferCard && <Typography className="text-sm!" component={'span'}> (32 نظر) </Typography>} 4.8/5</Typography>} />
                        </Stack>
                        <Stack className="flex! flex-col! gap-2!">
                            <Typography className="text-xl!" fontWeight={isOfferCard ? 500 : 400}>هتل بین المللی کیش </Typography>
